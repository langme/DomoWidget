...
public class ToogleWidgetBDD {
    ...
    static final String TAG      = "[DOMO_TOOGLE_BDD]";
    ...
    public long insertWidget(ToogleWidget widget){
        ...
        return bdd.insert(UtilsDomoWidget.TABLE_DOMO_WIDGET, null, values);
    }
    ...
    public int updateWidget(ToogleWidget widget){
        ...
        return bdd.update(UtilsDomoWidget.TABLE_DOMO_WIDGET, values, UtilsDomoWidget.COL_ID_WIDGET + " = " + widget.getDomoId(), null);
    }
    ...
    public int removeWidgetById(int idWidget){
        ...
        return bdd.delete(UtilsDomoWidget.TABLE_DOMO_WIDGET, UtilsDomoWidget.COL_ID_WIDGET + " = " + idWidget, null);
    }
    ...
    public ToogleWidget getWidgetById(int idWidget){
        ...
        Cursor c = bdd.query(UtilsDomoWidget.TABLE_DOMO_WIDGET, new String[] {
                                ...
                                UtilsDomoWidget.COL_TIME_OUT}, UtilsDomoWidget.COL_ID_WIDGET + " LIKE \"" + idWidget +"\"" , null, null, null, null);
